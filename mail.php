...
if ($name == "") {
    ...
    $msg['err'] = "\n Please put a valid phone number! Example: 2001008000";
    $msg['field'] = "contact-phone";
    $msg['code'] = FALSE;
} else if ($email == "") {
    ...
    $to = 'contact@edwardclark.dev';
    $subject = 'Request from Landing Page';
    ...
    $headers .= 'From:  Edward Clark <contact@edwardclark.dev>' . "\r\n";
    $headers .= 'cc: contact@edwardclark.dev' . "\r\n";
    $headers .= 'bcc: contact@edwardclark.dev' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f contact@edwardclark.dev');
